...
namespace fth
{
	...
	public://Public interface to interact with the singleton
		...
		void LogMessage(LoggerType type, SeverityLevel severity, std::string_view subsystemCaller, Args&&... args);
	...
	{
		auto& logger = (type == LoggerType::Engine) ? m_engineLogger : m_clientLogger;
